...
struct retro_core_option_v2_definition option_defs_us[] = {
  ...
  {"swanstation_Controller_ShowCrosshair",
   ...
   "true"},
  {"swanstation_Controller_GunconInputMode",
   "GunCon Input Mode",
   NULL,
   "Use relative lightgun tracking or absolute pointer positioning for GunCon input. Absolute mode enables direct stylus positioning for compatible touchscreen devices.",
   NULL,
   "port",
   {
     {"lightgun", "Light Gun"},
   ...
   "lightgun"},
  {"swanstation_spen_coordinate_mode",
   ...
   "absolute"},
  {"swanstation_spen_input_mode",
   "S-Pen Input Mode",
   "Mode",
   "S-Pen input device mode. Auto-detect automatically switches between mouse and lightgun based on S-Pen configuration. Manual modes force specific input types.",
   NULL,
   "input",
   {
     {"auto", "Auto-Detect"},
     {"mouse", "Force Mouse"},
     {"lightgun", "Force Lightgun"},
     {NULL, NULL},
   },
   "auto"},
  {"swanstation_spen_tap_action",
   "S-Pen Tap Action",
   NULL,
   "Configure what stylus tap (screen contact) does in pointer mode.",
   NULL,
   "port",
   {
   ...
   "trigger"},
  {"swanstation_spen_barrel_action",
   "S-Pen Barrel Action", 
   NULL,
   "Configure what the S-Pen barrel (side) button does in pointer mode.",
   NULL,
   "port",
   {
     {"right_click", "Right Click"},
   ...
   "right_click"},
  {"swanstation_Controller_SPenPSMouseAbsoluteMode",
   "PlayStation Mouse S-Pen Mode",
   NULL,
   "Use absolute pointer positioning for PlayStation Mouse with S-Pen/stylus input. Enables direct stylus positioning for drawing and painting games.",
   NULL,
   "port",
   {
     {"false", "Disabled"},
